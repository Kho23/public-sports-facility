          ...
          <div className="border border-gray-200 bg-gray-50 rounded-lg p-4 shadow-sm">
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-gray-700 ml-1">
                • 모든 시설은 <b className="text-gray-900">06시 ~ 22시</b>까지
                운영됩니다.
              </p>
            </div>
            <div className="mb-4">
              <p className="text-sm font-semibold text-gray-800 mb-1">수영장</p>
            ...
            <div className="mb-4">
              <p className="text-sm font-semibold text-gray-800 mb-1">헬스장</p>
              <div className="text-xs text-gray-700 space-y-1 ml-1">
                <p>
                  • 1일 이용 :{" "}
