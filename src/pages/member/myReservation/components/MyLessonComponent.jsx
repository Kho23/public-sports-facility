...
import { cancelRegistration, getRegistrationList } from '../../../../api/memberApi'
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-white pt-10 md:pt-20">
      ...
      <div className="w-full max-w-4xl px-4 pb-20">
        {registration && registration.length > 0 && registration[0].registrationId !== 0 ? (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center text-sm text-gray-600 gap-2 sm:gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="font-mono text-gray-500">{formatter(i) }</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className={`px-4 py-2 rounded-full text-sm font-bold border ${
                  i.status === 'CANCELED' ? 'bg-red-50 text-red-600 border-red-200' :
                  i.status === 'APPLIED' ? 'bg-blue-50 text-[#263c79] border-blue-200' :
                  'bg-gray-50 text-gray-600 border-gray-200'
                }`}>
                  {i.status=="CANCELED"?"취소됨":i.status=="APPLIED"?"신청 완료":"상태 미정"}
                </span>
