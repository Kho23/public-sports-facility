    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="border border-gray-300 rounded-xl p-6 mb-8 bg-white shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
          ...
          <div className="flex flex-col">
            <label className="text-gray-700 font-semibold mb-1">연락처</label>
            <input
              type="text"
              name="phoneNumber"
              onChange={(e) => infoHandler(e)}
          ...
          <div className="flex flex-col">
            <label className="text-gray-700 font-semibold mb-1">요청사항</label>
            <input
              type="text"
              name="memo"
              onChange={(e) => infoHandler(e)}
        ...
        <p className="text-xs text-gray-500 mt-4 leading-relaxed">
          ※ 신청자 정보는 대관 승인, 취소 안내 등 주요 연락을 위해 사용됩니다.
        </p>
      </div>
      ...
      <div className="flex gap-6">
        ...
        <div className="w-[35%] border rounded-md p-4">
          ...
          {!facility || !space ? (
            ...
            <div className="mt-4">
              <p className="text-lg font-bold text-gray-800 mb-3">시간 선택</p>
              <div>
                  ...
                  {scheduleData?.map((i) => (
                    <button
                      ...
                      className={`border rounded-md p-2 text-sm hover:bg-gray-100 ${
                        selectTime.includes(i) ? "bg-blue-900 text-white" : ""
                      }`}
                    >
                      {i}
                    </button>
